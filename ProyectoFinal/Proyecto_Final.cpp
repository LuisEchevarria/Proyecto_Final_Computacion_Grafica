...
// Camera
Camera  camera(glm::vec3(0.0f, 2.0f, 10.0f)); // Moví la cámara un poco hacia atrás y arriba para que veas el modelo
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Conjunto Norte", nullptr, nullptr);
